...
export default function NodeEditButton({ node }) {
  ...
  return (
    <div className="absolute left-10 z-20 flex transform-gpu gap-2 antialiased opacity-75 transition-all duration-75 ease-in-out hover:scale-105 hover:opacity-100">
      <button
        onClick={editNode}
